...
<template>
  <CreateModal :closeModal="closeModal" :isOpen="isOpen" :createPost="createPostMutation" />

  <div class="flex justify-center items-center" v-if="getAllPostsMutation.isLoading.value">
  ...
  <div v-else class="flex px-5">
    <div class="lg:w-1/6 hidden lg:block h-screen sticky top-0 p-4">
      <button @click="openModal" class="w-full cursor-pointer bg-blue-500 hover:bg-blue-700 text-white h-10 rounded-2xl flex items-center justify-center" data-modal-toggle="defaultModal">Create Post</button>
